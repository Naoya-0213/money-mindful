        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex min-w-[80px] justify-center">
              <span className="text-xl font-bold">のために</span>
            </div>
          </div>

          {/* 期限 */}
          <div className="flex items-center gap-5">
            <p className="flex h-auto min-h-[65px] items-center justify-center rounded-xl bg-[#F3F0EB] px-6 py-4 text-xl font-bold">
              2025年9月30日
            </p>
            <div className="flex min-w-[80px] justify-center">
              <span className="text-xl font-bold">までに</span>
            </div>
          </div>
